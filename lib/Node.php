...
class Node {
    ...
    /**
     *
     * @var \Node[] The list of the step of any workflow in relationships with this node
     */
    private $workflowStepList = array();

    /**
     *
     * @var \Node[] The list of any relationships with this node
     */
    private $relationshipList = array();

    /**
     *
     * @var \Node[] The list of the attributs of with this node
     */
    ...
    /**
     *
     * @var string[] The list of any list functions (for __call())
     */
    ...
    /**
     *
     * @var string[] The list of any conf functions (for __call())
     */
    ...
    /**
     *
     * @var string[] The list of any microservice functions (for __call())
     */
    ...
    /**
     *
     * @var string[] The list of default attributs of this node
     */
    public $attributDefaultList = array(
            'accessMode',
            'showConf',
            'versionConf',
            'theme',
    ...
    /**
     *
     * @var \Node[] The list of any access modes in relationships with this node
     */
    public $accessModeList = array();

    /**
     *
     * @var \Node[] The list of any show modes in relationships with this node
     */
    public $showList = array();

    /**
     *
     * @var \Node[] The list of any themes in relationships with this node
     */
    public $themeList = array();

    /**
     *
     * @var \Node[] The list of any semantic nodes in relationships with this node
     */
    public $semanticList = array();

    /**
     *
     * @var \Node[] The list of any domains in relationships with this node
     */
    public $domainList = array();

    /**
     *
     * @var \Node[] The list of any scores in relationships with this node
     */
    public $scoreList = array();

    /**
     *
     * @var \Node[] The list of any avantages in relationships with this node
     */
    public $avantageList = array();

    /**
     *
     * @var \Node[] The list of any rights in relationships with this node
     */
    public $rightList = array();

    /**
     *
     * @var \Node[] The list of any values in relationships with this node
     */
    public $valueList = array();

    /**
     *
     * @var \Node[] The list of any states in relationships with this node
     */
    public $stateList = array();

    /**
     *
     * @var \Node[] The list of any child in relationships with this node
     */
    public $childList = array();

    /**
     *
     * @var \Node[] The list of any emotion in relationships with this node
     */
    public $emotionList = array();

    /**
     *
     * @var \Node[] The list of any comptaible actions in relationships with this node
     */
    public $actionList = array();

    /**
     *
     * @var \Node[] The list of any filter in relationships with this node
     */
    ...
    private function conf() {
        ...
        foreach ( $this->attributDefaultList as $listName ) {
